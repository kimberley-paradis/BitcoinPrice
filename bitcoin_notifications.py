...
IFTTT_WEBHOOKS_URL = 'https://maker.ifttt.com/trigger/Bitcoin_update/with/key/pBEltcK3TKOxhYDkGYyBA0A7I3GcHIOpSzodIeI4Y0s'
...
def main():
    ...
    while True:
        ...
        time.sleep(12 * 60)  # Sleep for 5 minutes (for testing purposes you can set it to a lower number)
